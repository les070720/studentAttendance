...
urlpatterns = [
    ...
    path('student_leave_view/', StaffViews.student_leave_view, name="student_leave_view"),
    path('student_leave_approve/<leave_id>/', StaffViews.student_leave_approve, name="student_leave_approve"),
    path('student_leave_reject/<leave_id>/', StaffViews.student_leave_reject, name="student_leave_reject"),
